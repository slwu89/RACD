...
RcppExport SEXP _RACD_RACD_Simulation(SEXP tMaxSEXP, SEXP thetaSEXP, SEXP humanSEXP, SEXP mosySEXP, SEXP houseSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Rcpp::IntegerVector& >::type mosy(mosySEXP);
    Rcpp::traits::input_parameter< const Rcpp::List& >::type house(houseSEXP);
    rcpp_result_gen = Rcpp::wrap(RACD_Simulation(tMax, theta, human, mosy, house));
